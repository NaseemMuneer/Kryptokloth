...
>>>>>>> 4a2d877efbf84f4fee90671e0ba465ba13db84ca
			...
			<Layout>
				<div className="container-fluid home-container pt-5">
					...
					<div className="intro-container">
						<h1>
							Shaping a sustainable fashion future in the age of
							artificial intelligence.
						</h1>
						<div className="choose-input">
							<p>
								Upload an image of the design that inspires you
							</p>
...
=======
					...
					<div className="about-kryptokloth">
						<h1>Take a moment or two to get to know Kryptokloth</h1>
						<p>
							And then go change the world of fashion in a new and
							sustainable way.
						</p>
						<div className="conatiner-fluid video-container">
							<Video />
					...
					<div className="container-fluid assist-container">
						<div className="row justify-content-between px-5">
							<div className="col-6">
								<h1>
									Your fashion design creative assistant from
									beginning to end.
								</h1>
								<p className="px-5">
									Discover boundless inspiration for your
									upcoming fashion designs by harnessing the
									power of AI as your fashion assistant.
								</p>
								<div className="">
									<Button
										onClick={() => {
					...
					<div className="container-fluid web3-container ">
						<div className="row justify-content-between pt-5 align-items-center">
							<h1 className="text-center mb-5">
								Advanced and intuitive AI and Web 3 Tools to
								make your fashion future suatainable and
								hassle-free.
							</h1>
							<div className="col-6 advance-ai">
								<h3>
								...
								<p>
									A creative 360 micro universe where
									designers can come together to change the
									world. Be part of the new AI era where
									physical meets digital and reducing
					...
					<div className="container-fluid finishing-touch">
						<div className="row justify-content-between pt-5 align-items-center">
							<div className="col-12 finishing-content">
								...
								<p>
									Be the first join our list to get update
									before we go live.
								</p>
								<div className="d-flex email-dev">
									<input
									...
									/>
									<Button className="button-property-2">
										Email me
									</Button>
								</div>
							</div>
